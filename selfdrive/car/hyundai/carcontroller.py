...
class CarController():
  def __init__(self, dbc_name, CP, VM):
    ...
    self.sendaccmode = CP.openpilotLongitudinalControl
    self.enabled = False
      ...
      if frame % 2 == 0:
        ...
        if CS.brake_check == 1 or CS.mainsw_check == 1:
          can_sends.append(create_scc12(self.packer, apply_accel, enabled,
                                       ...
                                       CS.out.stockAeb,
                                       CS.scc12, self.usestockscc, CS.CP.radarOffCan, self.scc12cnt, stopping))
        else:
          can_sends.append(create_scc12(self.packer, apply_accel, enabled,
