...
IGNORED_FINGERPRINTS = [CAR.IONIQ_HEV, CAR.KIA_NIRO_EV, CAR.ELANTRA_2020, CAR.GENESIS_G70, CAR.KIA_SELTOS]
...
CHECKSUM = {
  "crc8": [CAR.SANTA_FE, CAR.SONATA, CAR.SONATA_HEV, CAR.PALISADE, CAR.KIA_SELTOS],
