...
class DynamicGas:
  ...
  def update(self, CS, extra_params):
    ...
    if self.lead_data['status']:  # if lead
      if v_ego <= 8.9408:  # if under 20 mph
        ...
        y = [2.0, 1.65, 1.25]  # maximum we can reduce gas_mod is 40 percent (never increases mod)
  ...
  def set_profile(self):
    ...
    y = [1.5, 1.457, 1.43, 1.380, 1.35, 1.32, 1.29, 1.21784, 1.1565, 1.48, 1.46, 1.39, 1.31, 1.28, 1.22, 1.17, 1.12, 0.95]
