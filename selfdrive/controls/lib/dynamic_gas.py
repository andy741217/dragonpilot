...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.65, 1.40, 1.38, 1.33, 1.33, 1.32, 1.31, 1.30, 1.27, 1.25, 1.24, 1.24, 1.23, 1.22, 0.92, 0.9, 0.88, 0.70]
      self.x_lead_mod_x = [6.1, 9.15, 15.24 ]
    elif self.dp_profile == DP_SPORT:
      #km/h[0,   5,    10,    15,    19,    22,    25,     29,      36,      43,   54,    64,    72,    87,    104,   117,    128   144]
      y = [0.95, 1.67, 1.63, 1.50, 1.53, 1.53, 1.5229, 1.51784, 1.50765, 1.48, 1.496, 1.509, 1.525, 1.38, 1.2, 1.1, 1.02, 0.9]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,    15,    19,    22,    25,     29,      36,      43,   54,    64,    72,    87,    104,   117,    128   144]
      y = [0.85, 1.45, 1.38, 1.33, 1.3, 1.32, 1.31, 1.30, 1.30, 1.28, 1.26, 1.24, 1.30, 1.25, 1.19, 1.1, 0.95, 0.8]
