...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.38, 1.40, 1.38, 1.33, 1.33, 1.32, 1.31, 0.30, 0.27, 0.25, 0.24, 0.24, 0.23, 0.22, 0.22, 0.21, 0.20, 0.20]
      self.x_lead_mod_x = [6.1, 9.15, 15.24 ]
    elif self.dp_profile == DP_SPORT:
      #km/h[0,   5,    10,    15,    19,    22,    25,     29,      36,      43,   54,    64,    72,    87,    104,   117,    128   144]
      y = [0.65, 1.67, 1.63, 1.50, 1.53, 1.53, 1.5229, 0.51784, 0.50765, 0.48, 0.496, 0.509, 0.525, 0.538, 0.45, 0.421, 0.42,0.35]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,    15,    19,    22,    25,     29,      36,      43,   54,    64,    72,    87,    104,   117,    128   144]
      y = [0.45, 1.42, 1.38, 1.33, 1.3, 1.32, 1.31, 0.30, 0.30, 0.28, 0.24, 0.21, 0.20, 0.20, 0.19, 0.19, 0.17, 0.15]
