...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.85, 0.950, 0.98, 1.33, 1.33, 1.2, 1.15, 1.0, 0.95, 0.9, 0.88, 0.85, 0.82, 0.75, 0.7, 0.65, 0.57, 0.45]
      self.x_lead_mod_x = [8.1, 12.15, 25.24, 35 , 50 ]
    elif self.dp_profile == DP_SPORT:
      #km/h[0,   5,    10,    15,   19,  22,   25,     29,      36,      43,   54,    64,    72,    87,    104,   117,  128  144]
      y = [1.0, 0.97, 1.15, 1.40, 1.53, 1.8, 1.89, 1.95, 1.85, 1.8, 1.76, 1.55, 1.52, 1.48, 1.42, 1.381, 1.35, 1.28]
