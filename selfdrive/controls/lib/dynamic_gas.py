...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [1.2, 1.21, 1.29, 1.32, 1.35, 1.45, 1.5, 1.550, 1.65, 1.7, 1.88, 2.15, 1.82, 1.675, 1.5, 1.35, 1.27, 1.2]
      self.x_lead_mod_x = [8.1, 12.15, 25.24, 35 , 50 ]
    elif self.dp_profile == DP_SPORT:
      #km/h[0,   5,    10,    15,    19,    22,    25,     29,      36,      43,   54,    64,    72,    87,    104,   117,    128   144]
      y = [1.8, 1.97, 2.15, 2.40, 2.53, 2.8, 2.89, 2.95, 2.85, 2.8, 2.76, 2.55, 2.52, 2.48, 2.42, 2.381, 2.35, 2.28]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,    15,    19,    22,    25,     29,      36,      43,   54,    64,    72,    87,    104,   117,    128   144]
      y = [1.55, 1.57, 1.43, 1.35, 1.33, 1.33, 1.3529, 1.36784, 1.37765, 1.38, 1.396, 1.309, 1.325, 1.358, 1.32, 1.301, 1.29, 1.25]
