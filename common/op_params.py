...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'Camera_Offset': Param(0.06, VT.number, 'This will reposition your vehicle if there is a lane hugging issue'
                        ...
                        'MdpsHarnessEnabled': Param(False, bool, 'somebody install mdpsharness'),
                        'SccEnabled': Param(True, bool, 'vehicle has scc radar'),
                        'SccHarnessPresent': Param(True, bool, 'vehicle radar not bus 0 and change to bus 2'),
                        'LongControlEnabled': Param(True, bool, 'vehicle use long control'),
                        'EnableOPwithCC': Param(False, bool, 'vehicle use op with scc'),
                        'RadarDisableEnabled': Param(False, bool, 'vehicle use long control'),
